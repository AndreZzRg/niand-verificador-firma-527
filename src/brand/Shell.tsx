...
export const MODULOS = [
  { id: 'firmar-documento', rotulo: 'Firmar documento' },
  { id: 'verificar-manifiesto', rotulo: 'Verificar manifiesto' },
  { id: 'gestion-de-claves', rotulo: 'Gestión de claves' },
  { id: 'criterios-ley-527', rotulo: 'Criterios Ley 527' },
  { id: 'bitacora', rotulo: 'Bitácora' },
] as const;
    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <header className="no-imprimir sticky top-0 z-30 border-b border-borde bg-superficie/92 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-4 gap-y-2 px-4 py-3 sm:px-6">
          <a
            href="https://github.com/AndreZzRg/niand-verificador-firma-527"
            className="shrink-0"
            aria-label="Repositorio de Verificador de Firma Ley 527"
          >
            <Logo alto={28} />
          </a>
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate font-display text-sm font-semibold">
              <span aria-hidden>🔏 </span>Verificador de Firma Ley 527
            </p>
