# Registro de decisiones de arquitectura — Verificador de Firma Ley 527
...
**Contexto.** GitHub Pages sirve el proyecto bajo `/niand-verificador-firma-527/`. Fijar esa ruta en la
