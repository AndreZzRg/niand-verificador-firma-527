# Arquitectura — Verificador de Firma Ley 527
...
Una carpeta por módulo: `firmar-documento`, `verificar-manifiesto`, `gestion-de-claves`, `criterios-ley-527`, `bitacora`.
...
`localStorage` bajo claves con prefijo `niand-verificador-firma-527:`.
